                    ...
                    <table class="table table-striped table-vcenter text-center">
                        ...
                        @foreach($requests ?? [] as $request)
                            <tr>
                                ...
                                <td style="min-width: 130px">{{ date('H:i d/m/Y', strtotime($request->created_at)) }}</td>
                                <td style="min-width: 150px">{{ $request->card_serial }}</td>
                                <td style="min-width: 150px">{{ $request->card_number }}</td>
