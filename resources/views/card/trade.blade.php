...
@section('contents')
    <div class="container-fluid">
        <h4 class="font-weight-bold mb-0 mt-4 text-center">Đổi thẻ cào</h4>
        <div class="body-content">
            <div class="box-pay-card p-3 mt-3">
                <div class="alert alert-warning">
                    <p class="font-weight-bold">Lưu ý:</p>
                    <ul style="list-style: decimal; padding-left: 20px">
                        <li><span class="color-red font-weight-bold">Quan trọng: </span>Thẻ Viettel cần điền đúng cả seri, điền sai seri khi lỗi sẽ bị xử lý chậm.</li>
                        <li>Không nhận <span class="font-weight-bold">API game bài</span>, cổng game bài cố tình đấu <span class="font-weight-bold">API sẽ bị khóa</span></li>
                        ...
                        <li><span class="font-weight-bold">Hướng dẫn tích hợp API gạch thẻ tự động cho Shop <a href="{{ route('connect-api') }}">tại đây</a>.</span></li>
                    </ul>
                </div>
                <hr />
                <form action="{{ route('trade-card.post') }}" method="POST">
                    ...
                    <div class="footer-button d-flex justify-content-center">
                        <button class="btn btn-warning color-yellow-bold ml-2">Gạch thẻ</button>
                    </div>
                </form>
            </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function(){
            if($('[name="card_type"]:checked').length == 0) {
                $('#area-card .box-card:first-child [name="card_type"]').trigger('click');
            }
